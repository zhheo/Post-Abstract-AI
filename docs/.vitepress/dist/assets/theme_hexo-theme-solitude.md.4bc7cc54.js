import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.867ce416.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"theme/hexo-theme-solitude.md","filePath":"theme/hexo-theme-solitude.md"}'),p={name:"theme/hexo-theme-solitude.md"},o=l(`<h2 id="hexo-theme-solitude" tabindex="-1">hexo-theme-solitude <a class="header-anchor" href="#hexo-theme-solitude" aria-label="Permalink to &quot;hexo-theme-solitude&quot;">​</a></h2><div class="img_container"><p><img src="https://bu.dusays.com/2024/04/18/6620a11060052.webp" alt="已接入文章摘要"></p></div><p>详细配置信息前往 <a href="https://solitude-docs.efu.me/third_party/tianliai" target="_blank" rel="noreferrer">Solitude 文档</a> 查看。</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 文章摘要AI</span></span>
...
<span class="line"><span style="color:#24292E;">  </span><span style="color:#22863A;">tips</span><span style="color:#24292E;">: </span><span style="color:#6A737D;"># 此内容根据文章生成，并经过人工审核，仅用于文章内容的解释与总结</span></span></code></pre></div>`,4),e=[o];function t(c,r,E,y,i,d){return n(),a("div",null,e)}const m=s(p,[["render",t]]);export{A as __pageData,m as default};
